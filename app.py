...
st.write("This WebApp allows you to estimate the calories burned based on your personal health data. By entering parameters such as age, gender, BMI, height, weight, and activity level, the system will predict the number of kilocalories burned using machine learning models. The results will help you monitor your fitness progress and adjust your routines accordingly.")

st.sidebar.header("User Input Parameters: ")

def user_input_features():
    age = st.sidebar.slider("Person Age: ", 10, 100, 30)
